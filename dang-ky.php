                    ...
                    <div class="form-login">
                        <form id="formAddStu" method="post">
                            ...
                            <div class="form-fullname">
                                <input name="fname" class ="first-name"type="text" placeholder="Tên">
                                <input name="lname" class="last-name" type="text" placeholder="Họ">
                            </div>
                            ...
                            <div class="link">
                                <a href="/dang-nhap">
                                    <i class="icon md-arrow-right"></i>Đăng nhập
                                </a>
                            </div>
                          </form>
                    </div>
